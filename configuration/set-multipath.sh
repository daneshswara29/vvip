...
function vmess(){
clear
echo "Switching multipath xray to vmess by wongedan" | lolcat
echo "${RED}STOP NGINX"

systemctl stop nginx
rm -f /etc/nginx/conf.d/xray.conf
wget -q -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/daneshswara29/vvip/main/configuration/vmess.txt"
...
function vless(){
clear
echo "Switching multipath xray to vless by wongedan" | lolcat
echo "${RED}STOP NGINX"

systemctl stop nginx
rm -f /etc/nginx/conf.d/xray.conf
wget -q -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/daneshswara29/vvip/main/configuration/vless.txt"
chmod +x /etc/nginx/conf.d/xray.conf
...
function trojan(){
clear
echo "Switching multipath xray to trojan by wongedan" | lolcat
echo "${RED}STOP NGINX"
