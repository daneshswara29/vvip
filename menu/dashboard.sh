...
Exp2=$(curl -sS https://raw.githubusercontent.com/daneshswara29/vvip/main/gerung | grep $MYIP | awk '{print $3}')
...
#update
wget -q -O updatsc.sh "https://raw.githubusercontent.com/daneshswara29/vvip/main/menu/updateyes.sh" && chmod +x updatsc.sh && ./updatsc.sh 
