...
Name=$(curl -sS https://raw.githubusercontent.com/daneshswara29/vvip/main/gerung | grep $MYIP | awk '\''{print $2}'\'')
Exp=$(curl -sS https://raw.githubusercontent.com/daneshswara29/vvip/main/gerung | grep $MYIP | awk '\''{print $3}'\'')
...
bot
wget -q -O /usr/bin/lock "https://raw.githubusercontent.com/daneshswara29/vvip/main/limit/user-lock.sh" && chmod +x /usr/bin/lock
wget -q -O /usr/bin/unlock "https://raw.githubusercontent.com/daneshswara29/vvip/main/limit/user-unlock.sh" && chmod +x /usr/bin/unlock
clear
